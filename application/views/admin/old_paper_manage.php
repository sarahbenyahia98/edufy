<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_video_manager">
	    ...
	    <div class="edu_btn_wrapper sectionHolder padderBottom30 text-right">
            <?php echo ($role != 'student')?'<a href="#add_book_popup" class="edu_admin_btn openPopupLink"><i class="icofont-plus"></i>'. html_escape($this->common->languageTranslator('ltr_add_old_paper')) .'</a>':''; ?>
	    </div>
        ...
        <div class="createDivWrapper edu_add_question create_ppr_popup hide">
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner">
					...
					<?php if($role != 'student'){?>
                    <button class="multiDelete btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo html_escape($this->common->languageTranslator('ltr_delete'));?>" data-table="old_paper_pdf" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_delete'));?></button>
                    <?php }?>
        		</div>
					</div>
        		</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <select class="form-control require edu_selectbox_with_search filter_batch book_batch" name="batch[]" multiple data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_batch'));?>">
                                ...
                                <?php 
                                print_r($assign_batch);
                                    if($role==3){
                                        if(!empty($assign_batch))
                                {
                                    foreach($assign_batch as $bat){ 
    				...
    				<div class="col-lg-6 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <input type="file" class="form-control require" accepts="application/pdf" name="pdf_file" data-valid="pdfimage" data-error="<?php echo html_escape($this->common->languageTranslator('ltr_pdf_msg'));?>">
