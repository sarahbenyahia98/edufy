<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_video_manager">
		...
		<?php 
			// if((!empty($student_leave)) || (!empty($teacher_leave))){
			?>
	    <div class="edu_main_wrapper edu_table_wrapper">
			<div class="edu_admin_informationdiv sectionHolder">
                <div class="tableFullWrapper">
                    
                    <table class="server_datatable datatable table table-striped table-hover dt-responsive" cellspacing="0" width="100%" data-url="ajaxcall/manage_certificate/<?php echo $student_id; ?>">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo html_escape($this->common->languageTranslator('ltr_certificate'));?></th>
                                <th><?php echo html_escape($this->common->languageTranslator('ltr_view'));?></th>
                            </tr>
                        </thead>
    			        <tbody>
    			        </tbody>
