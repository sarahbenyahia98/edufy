        ...
        <div class="createDivWrapper edu_add_question create_ppr_popup hide">
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner">
					...
					<?php if($role != 'student'){?>
                    <button class="multiDelete btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete" data-table="video_lectures" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_delete'));?>
                    </button>
                    <button class="paidPreviewVideo btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete" data-table="video_lectures" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_not_preview'));?>
                    </button>
                    <button class="freePreviewVideo btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete" data-table="video_lectures" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_preview'));?>
                    </button>
                    <?php }?>
        		</div>
					</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <select class="form-control require edu_selectbox_with_search filter_chapter  batch_chapter" name="topic" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_chapter'));?>">
                                <option value=""><?php echo html_escape($this->common->languageTranslator('ltr_select_chapter'));?></option>
                            </select>
                        </div>
    				</div>
    				...
    				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="form-group hide video_type_video">
                            ...
                            <input type="file" class="form-control video_url"  name="video_file" data-valid="video" data-error="<?php echo html_escape($this->common->languageTranslator('ltr_video_msg'));?>" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_file'));?>" data-symb="no">
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group">
