                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group"> 
                            ...
                            <select class="form-control require edu_selectbox_with_search" name="batch_id[]" multiple data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_batch'));?>">
