<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_video_manager">
	    ...
	    <div class="edu_btn_wrapper sectionHolder padderBottom30 text-right">
            <?php echo ($role != 'student')?'<a href="#add_book_popup" class="edu_admin_btn openPopupLink"><i class="icofont-plus"></i>'. html_escape($this->common->languageTranslator('ltr_add_notes')) .'</a>':''; ?>
	    </div>
        ...
        <div class="createDivWrapper edu_add_question create_ppr_popup hide">
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner">
					...
					<?php if($role != 'student'){?>
                    <button class="multiDelete btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo html_escape($this->common->languageTranslator('ltr_delete'));?>" data-table="notes_pdf" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_delete'));?></button>
                    <?php }?>
        		</div>
					</div>
        		</div>
