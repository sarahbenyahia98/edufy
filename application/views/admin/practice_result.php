		...
		?>
    		...
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner">
				    ...
				    <button class="multiDelete btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete" data-table="practice_result" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_delete'));?></button>
				    <?php }?>
        		</div>
					</div>
        		</div>
	        ...
	        <div class="edu_main_wrapper edu_table_wrapper">
    	       <div class="tableFullWrapper">
				    ...
				    <table class="server_datatable datatable table table-striped table-hover dt-responsive" cellspacing="0" width="100%" data-url="ajaxcall/result_table/practice">
                        <thead>
                            <tr> 
