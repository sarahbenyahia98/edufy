                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <select class="form-control require edu_selectbox_with_search single_batch_sub" name="batch_id" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_batch'));?>" >
    			     ...
    			     <div class="col-lg-6 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <select class="form-control require edu_selectbox_with_search " id="subject_dropdown" name="subject_id" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_subject'));?>" data-count="no">
